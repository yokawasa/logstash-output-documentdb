...
```ruby
gem "logstash-output-documentdb", :path => "/your/local/logstash-output-documentdb"
```
- Install plugin
```sh
...
```sh
bin/logstash -e 'output {documentdb {}}'
```
...
```sh
gem build logstash-output-documentdb.gemspec
```
- Install the plugin from the Logstash home
```sh
bin/plugin install /your/local/plugin/logstash-output-documentdb.gem
```
